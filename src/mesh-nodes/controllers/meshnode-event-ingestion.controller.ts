...
import {
  ...
  IngestedEvent,
} from '../services/meshnode-event-ingestion.service';
...
export class MeshNodeEventIngestionController {
  constructor(
    private readonly ingestionService: MeshNodeEventIngestionService,
  ) {}

  @Post('ingest')
  @ApiOperation({
    summary: 'Ingest events and auto-create MeshNodes for relevant ones',
  })
  @ApiResponse({
    status: 201,
    description: 'MeshNodes auto-created for relevant events',
  })
  async ingestEvents(
